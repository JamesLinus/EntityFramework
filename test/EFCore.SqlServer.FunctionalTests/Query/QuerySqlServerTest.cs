...
{
    public partial class QuerySqlServerTest : QueryTestBase<NorthwindQuerySqlServerFixture<NoopModelCustomizer>>
    {
        public QuerySqlServerTest(NorthwindQuerySqlServerFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
